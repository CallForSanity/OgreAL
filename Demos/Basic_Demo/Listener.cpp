...
bool DeviceListener::keyPressed(const OIS::KeyEvent &arg)
{
	...
	case OIS::KC_ESCAPE:
		...
		case OIS::KC_F2:
			OgreAL::SoundManager::getSingleton().getSound("Roar")->pause();
			break;

		case OIS::KC_F3:
			OgreAL::SoundManager::getSingleton().getSound("Roar")->stop();
			break;

		case OIS::KC_F5:
			OgreAL::SoundManager::getSingleton().getSound("ZeroFactor")->play();
			break;

		case OIS::KC_F6:
			OgreAL::SoundManager::getSingleton().getSound("ZeroFactor")->pause();
			break;

		case OIS::KC_F7:
			OgreAL::SoundManager::getSingleton().getSound("ZeroFactor")->stop();
			break;
